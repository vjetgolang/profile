...
import { faBrightness, faMoon } from "@fortawesome/free-solid-svg-icons";
...
export const BlogNavbar = () => {
  ...
  return (
    <Navbar isBordered={false} variant="sticky" maxWidth={"sm"}>
      <Navbar.Brand>
        <AppLogo />
      </Navbar.Brand>
      ...
      <Navbar.Content>
        ...
        <Link
          css={{ color: "$accent6" }}
          href={"https://github.com/monokaijs/monokaijs.com/"}
          target={"_blank"}
        >
        ...
        <Button
          auto
          size={"md"}
          css={{ backgroundColor: "$gray50", color: "$text" }}
          onClick={openLogin}
        >
          Sign In
        </Button>
